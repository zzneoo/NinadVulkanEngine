...
// Helper to create and begin a single-time command buffer
VkCommandBuffer VulkanContext::BeginSingleTimeCommands(VkDevice device, VkCommandPool commandPool) {
...
void VulkanContext::EndSingleTimeCommands(VkDevice device, VkCommandPool commandPool, VkQueue graphicsQueue, VkCommandBuffer commandBuffer) {
